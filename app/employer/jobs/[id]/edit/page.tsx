...
export default function EditJobPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    // En una implementación real, aquí se cargarían los datos del trabajo desde la API
    setTimeout(() => {
      setJobData({
        ...
        description:
          "Estamos buscando un desarrollador frontend con experiencia en React y TypeScript para unirse a nuestro equipo de ingeniería. El candidato ideal tendrá experiencia en el desarrollo de aplicaciones web modernas y estará familiarizado con las mejores prácticas de desarrollo frontend.",
        requirements:
        ...
        applicationEmail: "rrhh@empresa.com",
        applicationUrl: "https://empresa.com/careers",
        isUrgent: true,
        isDraft: false,
      })
      setIsLoading(false)
        ...
        <main className="flex-1 py-8">
          <div className="container px-4 md:px-6 max-w-4xl">
            <div className="flex flex-col items-center justify-center h-[60vh]">
              ...
              <p className="mt-4 text-muted-foreground">Cargando información del empleo...</p>
            </div>
          </div>
        </main>
        <Footer />
      ...
      <main className="flex-1 py-8">
        <div className="container px-4 md:px-6 max-w-4xl">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold mt-4">Editar empleo</h1>
            <p className="text-muted-foreground">Actualiza la información de tu oferta de empleo</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {currentStep === 4 && (
              <Card>
                <CardHeader>
                  <CardTitle>Revisar y actualizar</CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-4">
            ...
            <div className="flex justify-between mt-6">
              ...
              {currentStep < 4 ? (
                ...
                <Button type="submit" className="gap-2">
                  ...
                  {jobData.isDraft ? "Guardar borrador" : "Actualizar empleo"}
                </Button>
              )}
            </div>
          </form>
